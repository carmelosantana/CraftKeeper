                ...
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            ...
                            // Task 4: no public registration — CraftKeeper is
                            // single-admin. The only account is created via
                            // the first-run onboarding wizard, not a
                            // "Register" link (see
                            // docs/architecture/decisions.md, Task 4).
                            <Link
                                href={login()}
